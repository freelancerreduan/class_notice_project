...
<form action="email/email.php" method="post" enctype="multipart/form-data">
    ...
    <input type="submit" name="notice_add" value="Main Add Notice" class="btn btn-primary btn-block">
